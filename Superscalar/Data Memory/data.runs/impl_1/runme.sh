...
HD_PWD='C:/Users/Shubhanshu Agarwal/data/data.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log data.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source data.tcl -notrace
