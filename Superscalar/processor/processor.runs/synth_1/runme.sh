...
HD_PWD='D:/Final program/processor/processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log superscalar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source superscalar.tcl
