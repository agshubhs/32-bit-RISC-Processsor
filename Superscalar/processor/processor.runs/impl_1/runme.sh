...
HD_PWD='D:/Final program/processor/processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log superscalar.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source superscalar.tcl -notrace
