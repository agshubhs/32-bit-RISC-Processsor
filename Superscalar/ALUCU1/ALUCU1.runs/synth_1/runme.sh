...
HD_PWD='E:/B. Tech II year/CSN_221/Project/32-bit-MIPS-Processor-master/Modules/ALU Control Unit/ALUCU1/ALUCU1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_CU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_CU.tcl
