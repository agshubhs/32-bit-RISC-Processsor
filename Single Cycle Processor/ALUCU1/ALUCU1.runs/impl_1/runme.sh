...
HD_PWD='E:/B. Tech II year/CSN_221/Project/32-bit-MIPS-Processor-master/Modules/ALU Control Unit/ALUCU1/ALUCU1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_CU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_CU.tcl -notrace
